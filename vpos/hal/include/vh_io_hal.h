...
#define vh_ULCON	 		(*(volatile unsigned *)(vh_UART_CTL_BASE+0x400))	// ULCON1
#define vh_UCON	 			(*(volatile unsigned *)(vh_UART_CTL_BASE+0x404))	// UCON1
#define vh_UFCON	 		(*(volatile unsigned *)(vh_UART_CTL_BASE+0x408))	// UFCON1
#define vh_UMCON	 		(*(volatile unsigned *)(vh_UART_CTL_BASE+0x040c))	// Specifies modem control
#define vh_UBRDIV	 		(*(volatile unsigned *)(vh_UART_CTL_BASE+0x0428))	// UBRDIV1

...
TCL_EXTRA_CFLAGS='-isystem/opt/s5pc1xx/staging/armv7a-s5pc1xx-linux-gnueabi/usr/include -fexpensive-optimizations -frename-registers -fomit-frame-pointer -O2 -pipe -isystem/opt/s5pc1xx/staging/armv7a-s5pc1xx-linux-gnueabi/usr/include'
...
TCL_LD_FLAGS='-L/opt/s5pc1xx/staging/armv7a-s5pc1xx-linux-gnueabi/usr/lib -Wl,-rpath-link,/opt/s5pc1xx/staging/armv7a-s5pc1xx-linux-gnueabi/usr/lib -Wl,-O1 -Wl,--hash-style=gnu -Wl,--export-dynamic'
...
TCL_RANLIB='arm-s5pc1xx-linux-gnueabi-ranlib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/opt/s5pc1xx/staging/armv7a-s5pc1xx-linux-gnueabi/usr/include/tcl8.4.19/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC=' -ltcl8.4${TCL_DBGX}'
...
# compiled.
TCL_SRC_DIR='/opt/s5pc1xx/staging/armv7a-s5pc1xx-linux-gnueabi/usr/include/tcl8.4.19'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/opt/s5pc1xx/staging/armv7a-s5pc1xx-linux-gnueabi/usr/include/tcl8.4.19/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC=' -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/opt/s5pc1xx/staging/armv7a-s5pc1xx-linux-gnueabi/usr/include/tcl8.4.19/unix/libtclstub8.4${TCL_DBGX}.a'
